      ...
      <div className={cookiesAccepted === null ? 'disabled-content' : ''}>
        <div className='home-container'>
          ...
          <section className='home-banner'>
            <h3>If you have a <strong>dream</strong></h3>
            <h3>we will turn it into <strong>reality</strong></h3>
          </section>
          ...
          <section className='banner-displays'>
            <div className='banner-display-section'>
              ...
              <div className='banner-display-info'>
                ...
                <p>
                  We can aid you in renovating the divisions of your home, making them elegant, function and modern.
                </p>
              </div>
            </div>
            <div className='banner-display-section'>
              ...
              <div className='banner-display-info'>
                ...
                <p>
                  Looking for building your dream home?
                  <br></br>
                  We can aid you into turning that dream into a reality.
                </p>
              </div>
            </div>
          </section>
          <CallToActionBtn
            description="Check Works"
            link='/Works'
          />
        </div>
      </div>
