  ...
  return (
    <>
      <section className='services-container'>
        ...
        >
          <option value="">Choose what you want to see</option>
          <option value="small-project">Smaller Projects</option>
          <option value="big-project">Bigger Projects</option>
        </select>
            ...
            <article className='services-options' key={index}>
              ...
              <section className='services-info'>
                ...
                <p className='services-price'>
                  Price: Starting from... {price.toLocaleString('pt-PT', { style: 'currency', currency: 'EUR' })}
                </p>
